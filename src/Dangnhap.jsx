...
function Dangnhap({ setIsLoggedIn}) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('https://backend-dacn-hmw1.onrender.com/api/token/', payload);
      ...
      const userRes = await axios.get('https://backend-dacn-hmw1.onrender.com/api/user/', {
      ...
      if (user.is_superuser) {
        window.location.href = 'https://backend-dacn-hmw1.onrender.com/dashboard/';
      } else {
        navigate('/'); 
      }
